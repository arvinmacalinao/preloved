                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('product.type.create') }}" title="Add {{ $data['page'] }}" class="btn btn-sm btn-primary">Add {{ $data['page'] }}</a>
                            </div>
                        </div>
                            ...
                            <table class="table text-center table-flush">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success btn-sm row-edit-btn" href="{{ route('product.type.edit', ['id' => $row->prod_type_id]) }}" title="Edit"><i class="fa fa-pencil"></i></a>
                                        <a class="btn btn-danger btn-sm  row-delete-btn" href="{{ route('product.type.delete', ['id' => $row->prod_type_id]) }}" data-msg="Delete this item?" data-text="#{{ $ctr }}" title="Delete"><i class="fa fa-trash-o"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
