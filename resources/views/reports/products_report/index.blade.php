                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-4">
                                <div class="pull-right">
                                    <a class="btn btn-info btn-sm" id="" href="{{ route('products.report.pdf') }}" name="download-list-btn" class="print-download-btn pr" title="Download List"><span class="fa fa-floppy-o"></span> Print</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-flush">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{ $row->orderdetails->where('prod_id', $row->prod_id)->sum('order_quantity') ?? 0 }}</td>
                                ...
                                <tr style="border">
                                    ...
                                    @endphp
                                    <td style="text-align: right;"><strong>{{ $totalQuantity ?? 0 }}</strong></td>
                                    @php
